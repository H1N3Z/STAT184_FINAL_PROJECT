...
This table includes the player who were inducted into the hall of fame. 
```{r}
InductedP<-
  HallOfFame%>%
  filter(inducted == "Y")%>%
...
```
This table selects only the player, the team they were on, and their salary. 
```{r}
Money<-
  Salaries%>%
...
This join allows us to see the salaries of the players in the hall of fame.
```{r}
HallMoney<-
  InductedP%>%
